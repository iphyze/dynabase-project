...
$select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_title LIKE '%$search%' || division LIKE '%$search%' || project_country LIKE '%$search%' || project_city LIKE '%$search%' || project_status LIKE '%$search%' || tender_code LIKE '%$search%' || progress LIKE '%$search%' || created_at LIKE '%$search%'");
...
$all_client = $clients_name . ", ";
$all_keyperson = $keyperson . ", ";
...
<tr>
    ...
    <td style="border: 1px solid black"><?php echo ($clients_name == "") ? "None" : $all_client; ?></td>
    <td style="border: 1px solid black"><?php echo ($keyperson == "") ? "None" : $all_keyperson; ?></td>
    ...
    <td style="border: 1px solid black"><?php echo $tender_document; ?></td>
<!--    <td style="border: 1px solid black"><?php //echo $other_tender_doc; ?></td>-->
    <td style="border: 1px solid black"><?php echo $technical_document; ?></td>
