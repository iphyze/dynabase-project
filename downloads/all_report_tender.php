...
<tr>
	...
	<td style="border: 1px solid black; color: white; background-color: black; font-weight: bold">End User / Owner</td>
...
<tr>
    ...
    <td style="border: 1px solid black"><?php echo $end_user; ?></td>
