...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2023 at 01:38 AM
...
(107, 'AfreximBank', '', 'https://www.afreximbank.com', 'No. 2 Gnassingbe Eyadema Street Off Yakubu Gowon Crescent Asokoro, Abuja, Nigeria', 'Abuja', 'End User / Owner', 's.ashafa@lambertelectromec.com', '2023-02-14 13:19:39', 'm.sofuye', '2023-05-24 02:56:00'),
...
(163, 'AfreximBank', 107, '', 'No. 2 Gnassingbe Eyadema Street Off Yakubu Gowon Crescent Asokoro, Abuja, Nigeria', 'Abuja', 'End User / Owner', 'Abdoulaye Kone', '2349087357621', 'akone@afreximbank.com', 'Regional Chief Operating Officer', '', 's.ashafa@lambertelectromec.com', '2023-02-14 13:22:54', 'm.sofuye', '2023-05-24 02:56:00'),
(164, 'AfreximBank', 107, '', 'No. 2 Gnassingbe Eyadema Street Off Yakubu Gowon Crescent Asokoro, Abuja, Nigeria', 'Abuja', 'End User / Owner', 'Oluwaseun Alabi', '2349088928236', 'oalabi@afreximbank.com', 'Assistant Manager Administration', '', 's.ashafa@lambertelectromec.com', '2023-02-14 13:25:10', 'm.sofuye', '2023-05-24 02:56:00'),
...
(223, 'AfreximBank', 107, '', 'No. 2 Gnassingbe Eyadema Street Off Yakubu Gowon Crescent Asokoro, Abuja, Nigeria', 'Abuja', 'End User / Owner', 'Eric Monchu Intong', '201222999044', 'imonchu@afreximbank.com', 'Senior Manager', '', 's.ashafa@lambertelectromec.com', '2023-02-17 10:57:43', 'm.sofuye', '2023-05-24 02:56:00'),
...
INSERT INTO `log_table` (`id`, `clients_id`, `clients_name`, `key_person`, `clients_hq_location`, `clients_category`, `log`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 14, 'Costec Consultant', 'A.J. Alufohai', 'Lagos', 'Other Consultants', 'This log is for keyperson A.J. Alufohai and his client is Costec Consultant, just checking if it will log.\n\nThis is my first log', '2023-05-24 20:28:01', 'admin@lambertelectromec.com', '2023-05-24 20:28:01', 'admin@lambertelectromec.com'),
(2, 14, 'Costec Consultant', 'A.J. Alufohai', 'Lagos', 'Other Consultants', 'This is log 2 belonging to the above client!', '2023-05-24 21:07:02', 'admin@lambertelectromec.com', '2023-05-24 21:07:02', 'admin@lambertelectromec.com'),
(3, 69, 'Turner And Townsend', 'Folarin Olaleye', 'Lagos', 'Project Manager', 'This is a log for another keyperson, and the below reason is why he has been logged.\r\n\r\nThis is just to test this.', '2023-05-24 21:14:45', 'admin@lambertelectromec.com', '2023-05-24 21:14:45', 'admin@lambertelectromec.com'),
(4, 70, 'UICL', 'Abbass Atwi', 'Lagos', 'General Contractor', 'Engineering, Procurement, Construction (EPC) approach consists of:- Concept Studies, Pre-FEED, FEED & Detailed Engineering Design, Construction Pipeline Systems, Gas Processing, Electrical, Mechanical & Process Facilities, Pipes, Valves, Turbine Generator', '2023-05-25 08:26:01', 's.ashafa@lambertelectromec.com', '2023-05-25 08:26:01', 's.ashafa@lambertelectromec.com'),
(5, 117, 'Medallion', 'Adebunmi Oluwafemi', 'Lagos', 'Other Consultants', 'This is just a test log', '2023-05-25 08:31:41', 'm.sofuye@lambertelectromec.com', '2023-05-25 08:31:41', 'm.sofuye@lambertelectromec.com'),
(6, 14, 'Costec Consultant', 'A.J. Alufohai', 'Lagos', 'Other Consultants', 'Add log', '2023-05-25 08:56:51', 'admin@lambertelectromec.com', '2023-05-25 08:56:51', 'admin@lambertelectromec.com'),
(7, 107, 'AfreximBank', 'Abdoulaye Kone', 'Abuja', 'End User / Owner', 'Do another log for Abdoulaye Kone', '2023-05-25 09:05:51', 'admin@lambertelectromec.com', '2023-05-25 09:05:51', 'admin@lambertelectromec.com'),
(8, 118, 'Ouranos', 'Adedotun Adeyemi', 'Lagos', 'Other Consultants', 'KFGJGLKH;KLH;IOJH', '2023-05-25 10:01:41', 's.ashafa@lambertelectromec.com', '2023-05-25 10:01:41', 's.ashafa@lambertelectromec.com');
...
--
-- Table structure for table `pm_users_table`
--

CREATE TABLE `pm_users_table` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pm_users_table`
--

INSERT INTO `pm_users_table` (`id`, `fname`, `lname`, `email`, `password`, `integrity`, `created_by`, `updated_by`) VALUES
(1, 'Admin', 'User', 'pmsadmin@lambertelectromec.com', '608f72eb95bfaefe1a826a7dc97b3cfe', 'PMS Admin', 'admin@lambertelectromec.com', 'admin@lambertelectromec.com');
...
--
-- Indexes for table `pm_users_table`
--
ALTER TABLE `pm_users_table`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pm_users_table`
--
ALTER TABLE `pm_users_table`
