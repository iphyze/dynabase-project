<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all awaiting tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Awaiting Tender</div>

    <a href="downloads/awaiting_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'awaiting' ORDER BY id DESC");
                ...
                ?>
                <tr>
                    <td colspan="7">No projects are currently awaiting!</td>
                </tr>
                <?php
                }
                ?>
