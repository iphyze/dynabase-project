<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        All Submitted Tender    
        </div>
        <div class="user-welcome-subtext wow fadeIn" data-wow-delay='.5s'>
        View all submitted tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Pending Tender</div>

    <a href="downloads/submitted_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'submitted' ORDER BY id DESC");
                ...
                ?>
                <tr>
                    <td colspan="7">No projects have been submitted!</td>
                </tr>
                <?php
                }
                ?>
