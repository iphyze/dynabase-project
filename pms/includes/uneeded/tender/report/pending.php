<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all pending tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <a href="downloads/pending_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'pending' ORDER BY id DESC");
