...
<a href="inprogress_report.php" class="back-btn full-width" onclick="return confirm('You\'re about to download this report in excel format, is that ok?')">Export Tender In Progress Report</a>
<?php
...
$select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'In Progress' ORDER BY id DESC LIMIT $offset, $results_per_page");
...
<div class="pagination-box">
    <?php include_once('./includes/pagination/inprogress_pagination.php');?>
</div>