...
<a href="approved_report.php" class="back-btn full-width" onclick="return confirm('You\'re about to download this report in excel format, is that ok?')">Export Approved Tender Report</a>
<?php
...
$select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'Approved' ORDER BY id DESC LIMIT $offset, $results_per_page");
...
<div class="pagination-box">
    <?php include_once('./includes/pagination/approved_pagination.php');?>
</div>