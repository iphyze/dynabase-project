<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all user details below, edit, delete data. 
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $results_per_page = 5;
                    $pick = mysqli_query($db, "SELECT * FROM pm_users_table");
                    $total_results = mysqli_num_rows($pick);
                    $total_page_num = ceil($total_results/$results_per_page);
                    $offset = ($num - 1) * $results_per_page;

                    $select = mysqli_query($db, "SELECT * FROM pm_users_table ORDER BY id DESC LIMIT $offset, $results_per_page");
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            if($integrity == "PMS Admin"){
                                echo '<span class="stat-approved">PMS Admin</span>';
