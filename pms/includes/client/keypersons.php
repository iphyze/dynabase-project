<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all profiled contacts details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">All Contact Data</div>
...
//                    $offset = ($num - 1) * $results_per_page;
                    ...
                    $select = mysqli_query($db, "SELECT * FROM keypersons_table WHERE created_by = '{$_SESSION['email']}' ORDER BY created_at DESC");
