<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        <div class="user-welcome uw-thin wow fadeInUp">
         <?php 
         
         $hour = date('h') - 1;
         
         if($_SESSION['fname'] == "Bala"){
            $welcome_name = 'Engr ' . $_SESSION['fname'];
         }else{
            $welcome_name = $_SESSION['fname'];
         }


        if($hour < 12){

            echo 'Good day ' . $welcome_name . ', <br />Hope you are having a great day!';
        ...
        This allows for creation & merging of companies with contact persons.    
        </div>
            ...
            <div class="box-wrapper">
                ...
                <div class="bx-wrapper-col bxwc-split wow fadeInUp" data-wow-delay='.5s'>
                        ...
                        <a href="index.php?page=clients" class="grid-box-col gb-color-1">
                            <div class="grid-box-title">Clients</div>
                        ...
                        <a href="index.php?page=keypersons" class="grid-box-col gb-color-2">
                            <div class="grid-box-title">My Contact</div>
                        ...
                        <!--
                        <a href="index.php?page=add_client" class="grid-box-col gb-color-3">
                            <div class="grid-box-title">Add Client</div>
                            <div class="grid-box-figure fas fa-plus"><?php //getTotalPresentationDocuments() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                        </a>
                        -->

                        <a href="index.php?page=add_keyperson" class="grid-box-col gb-color-4">
                            <div class="grid-box-title">Add Contact</div>
                            <div class="grid-box-figure fas fa-plus"><?php //getTotalTenderDocuments() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                        </a>
