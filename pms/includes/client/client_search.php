...
$select = mysqli_query($db, "SELECT * FROM clients_table WHERE (created_by = '{$_SESSION['email']}') && (clients_name LIKE '%$search%' || clients_email LIKE '%$search%' || clients_hq_location LIKE '%$search%' || clients_category LIKE '%$search%')");
...
<div class="table-container">
    ...
    <div class="form-title">Clients Table</div>
