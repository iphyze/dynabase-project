...
<div class="table-container">
    ...
    <div class="form-title">Other Consultants Clients Data</div>
...
//                    $total_page_num = ceil($total_results/$results_per_page);
                    ...
                    $select = mysqli_query($db, "SELECT * FROM clients_table WHERE clients_category = 'Other Consultants' && created_by = '{$_SESSION['email']}' ORDER BY clients_name ASC");
