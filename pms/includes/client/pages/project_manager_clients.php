...
<div class="table-container">
    ...
    <div class="form-title">Project Manager Clients Data</div>
...
//                    $total_page_num = ceil($total_results/$results_per_page);
                    ...
                    $select = mysqli_query($db, "SELECT * FROM clients_table WHERE clients_category = 'Project Manager' && created_by = '{$_SESSION['email']}' ORDER BY clients_name ASC");
