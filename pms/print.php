...
function Header()
{
    ...
    $this->AddFont('Montserrat-SemiBold','','Montserrat-SemiBold.php'); //Bold
...
$pdf->AddFont('Montserrat-SemiBold','','Montserrat-SemiBold.php'); //SemiBold
...
$pdf -> Cell(190, 5, 'TENDER', 0, 'L', false);

$pdf -> ln();

$pdf -> SetFont('Montserrat-SemiBold', '', '16');
$pdf -> SetTextColor(89, 186, 89);
$pdf -> MultiCell(190, 5, strtoupper($project_title), 0, 'L', false);
...
$pdf -> SetFillColor(255, 255, 255);
$pdf -> SetTextColor(0, 0, 0);
$pdf -> Cell(190, 10, 'PROJECT CLIENT/DIVISION', 0, 'L', false);

$pdf -> SetFont('Montserrat-SemiBold', '', '10');
$pdf -> SetFillColor(255, 255, 255);
$pdf -> SetTextColor(89, 186, 89);
$pdf -> Cell(27, 5, 'Project Client:', 0, 0, 'L', false);
$pdf -> SetFont('Montserrat-Regular', '', '10');
$pdf -> SetTextColor(0, 0, 0);
$pdf -> Cell(163, 5, $project_client, 0, 0, 'L', false);
