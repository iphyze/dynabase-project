...
<a href="onhold_report.php" class="back-btn full-width" onclick="return confirm('You\'re about to download this report in excel format, is that ok?')">Export Tender On Hold Report</a>
<?php
...
$select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'On Hold' ORDER BY id DESC LIMIT $offset, $results_per_page");
...
?>
<div class="display-content">
    <div class="dc-box-title">There is no tender currently on hold!</div>
</div>
<?php
}
?>
<div class="pagination-box">
    <?php include_once('./includes/pagination/onhold_pagination.php');?>
</div>