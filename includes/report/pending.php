...
<a href="pending_report.php" class="back-btn full-width" onclick="return confirm('You\'re about to download this report in excel format, is that ok?')">Export Pending Tender Report</a>
<?php
...
$select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'pending' ORDER BY id DESC LIMIT $offset, $results_per_page");
...
<div class="pagination-box">
    <?php include_once('./includes/pagination/pending_pagination.php');?>
</div>