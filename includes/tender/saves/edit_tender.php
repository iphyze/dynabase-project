...
<!--
			<div class="form-group">
                ...
                <div class="form-control">
                    <input type="text" name="project_owner" value="<?php //echo $project_owner ?>">
                    <span class="fas fa-tasks"></span>
                </div>
            </div>
-->
			...
			<div class="form-group">
                ...
                <div class="form-control">
                    <select name="end_user">
                        <option value="<?php echo $end_user ?>"> -- <?php echo $end_user ?> -- </option>
                        
                        <?php
                        
                        $getEnd = mysqli_query($db, "SELECT DISTINCT clients_name FROM clients_table WHERE clients_category = 'End User / Owner' ORDER BY clients_name ASC");
                        $gottenEnd = mysqli_fetch_assoc($getEnd);
                        $numPm = mysqli_num_rows($getEnd);
                        
                        if($numPm > 0){
                            foreach($getEnd as $gottenEnd){
                            $clients_name_end = $gottenEnd['clients_name'];
//                            $clients_id_end = $gottenPm['id'];
//                            $clients_data_end = $gottenEnd['clients_name'] . " - " . $gottenEnd['key_person'];
                        ?>
                        
                        <option value="<?php echo $clients_name_end?>"><?php echo $clients_name_end?></option>
            ...
            <div class="form-group">
                ...
                <div class="form-control">
                    <select name="qs_manager">
                        <option value="<?php echo $qs_manager; ?>"> -- <?php echo $qs_manager; ?> -- </option>
            ...
            <div class="form-group">
                ...
                <div class="form-control">
                    <select name="mep_consultants">
                        <option value="<?php echo $mep_consultants; ?>"> -- <?php echo $mep_consultants; ?> -- </option>
            ...
            <div class="form-group">
                ...
                <div class="form-control">
                    <select name="architect">
                        <option value="<?php echo $architect; ?>"> -- <?php echo $architect; ?> -- </option>
...
<!--                        <option value="Pending">Pending</option>-->
			...
			<div class="form-group" id="city-box">
                <label>Select Tender City Code <span class="asterisk">***</span></label>
                <div class="form-control">
                    <select name="city_code" class="awarded-city-code">
