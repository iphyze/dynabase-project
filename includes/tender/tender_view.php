...
<div class="table-container">
    ...
    <a href="index.php?page=advanced_tender_view" class='success-message theme-color'>Advanced Search</a>
...
//                    $offset = ($num - 1) * $results_per_page;
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table ORDER BY id DESC");
