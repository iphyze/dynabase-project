<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        This provides a complete reports pertaining to your tender.    
        </div>
    ...
    <div class="home-heading-col-2">
        <div class="date-display">Date: <?php echo date('jS M, Y'); ?></div>
            ...
            <div class="box-wrapper">
                ...
                <div class="bx-wrapper-col bxwc-anime wow fadeInUp">
                    <div class="report-wrapper">Tender Status & Progress</div>
                    <div class="report-box">
                        <div class="report-box-anime">
                            <div class="report-report rr-pending"><?php getTotalPendingTender(); ?> - Pending [Progress]</div>
                            <div class="report-report rr-progress"><?php getTotalInProgressTender(); ?> - In Progress [Progress]</div>
                            <div class="report-report rr-awaiting"><?php getTotalAwaitingTender(); ?> - Awaiting [Progress]</div>
                            <div class="report-report rr-submitted"><?php getTotalSubmittedTender(); ?> - Submitted [Progress]</div>
                            <div class="report-report rr-approved"><?php getTotalApprovedTender(); ?> - Approved [Status]</div>
                            <div class="report-report rr-hold"><?php getTotalOnHoldTender(); ?> - On Hold [Status]</div>
                            <div class="report-report rr-declined"><?php getTotalDeclinedTender(); ?> - Declined [Status]</div>
                            <div class="report-report rr-abortive"><?php getTotalAbortiveTender(); ?> - Abortive [Status]</div>
                        </div>
                    </div>
                    
                    <div class="report-instruction">Click any of the categories below to fetch data as per the selected category</div>
                    
                    <div class="report-flexbox">
                        
<!--
                        <a href="index.php?page=tender_view">All</a>
                        <a href="index.php?page=pending" class="rrf-pending">Pending</a>
                        <a href="index.php?page=inprogress" class="rrf-progress" >In Progress</a>
                        <a href="index.php?page=awaiting" class="rrf-awaiting" >Awaiting</a>
                        <a href="index.php?page=submitted" class="rrf-submitted" >Submitted</a>
                        <a href="index.php?page=approved" class="rrf-approved">Approved</a>
                        <a href="index.php?page=onhold" class="rrf-hold">On Hold</a>
                        <a href="index.php?page=declined" class="rrf-declined">S: Declined</a>
                        <a href="index.php?page=awarded" class="rrf-progress">Awarded</a>
-->
                        
                        <a href="index.php?page=tender_view">All</a>
                        <a href="index.php?page=pending" class="rrf-pending">Received</a>
                        <a href="index.php?page=onhold" class="rrf-hold">On Hold</a>
                        <a href="index.php?page=approved" class="rrf-approved">Approved</a>
                        <a href="index.php?page=declined" class="rrf-declined">Declined</a>
                        <a href="index.php?page=inprogress" class="rrf-progress" >In Progress</a>
                        <a href="index.php?page=submitted" class="rrf-submitted" >Submitted</a>
                        <a href="index.php?page=awaiting" class="rrf-awaiting" >Feedbacks</a>
                        <a href="index.php?page=awarded" class="rrf-progress">Awarded</a>
                        <a href="index.php?page=abortive" class="rrf-abortive">Abortive</a>
                    </div>
                </div>
                ...
                <div class="bx-wrapper-col bxwc-split wow fadeInUp" data-wow-delay='.5s'>
                        ...
                        <a href="index.php?page=tender_view" class="grid-box-col gb-color-1">
                            ...
                            <div class="grid-box-days"><?php tenderLastYear() ?> Last Year</div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            
                        </a>
                        <a class="grid-box-col gb-color-2">
                            <div class="grid-box-title">Tender (This Month)</div>
                            <div class="grid-box-figure"><?php tenderThisMonth() ?></div>
                            <div class="grid-box-days"><?php tenderThisYear() ?> This Year</div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                        </a>
                        <a class="grid-box-col gb-color-3">
                            <div class="grid-box-title">Tender (This Week)</div>
                            <div class="grid-box-figure"><?php tenderThisWeek() ?></div>
                            <div class="grid-box-days"><?php tenderThisMonth() ?> This Month</div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                        </a>
                        <a class="grid-box-col gb-color-4">
                            <div class="grid-box-title">Tender (Today)</div>
                            <div class="grid-box-figure"><?php tenderThisDay() ?></div>
                            <div class="grid-box-days"><?php tenderThisWeek() ?> This Week</div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                        </a>
        ...
        <div class="detailed-report-container">
            ...
            <div class="detailed-report-flexbox">
                ...
                <div class="drf-col">
                    ...
                    <div class="dfr-col-flexbox">
                        <div class="drfc-fb-status-title">P: Declined</div>
                        <div class="drfc-fb-status-bar"><div class="status-bar-guide drfcs-declined"></div></div>
                        <div class="drfc-fb-status-number"><?php getTotalDeclinedProgressTender() ?></div>
                    </div>
                    ...
                    <div class="dfr-col-flexbox">
                        <div class="drfc-fb-status-title">S: Declined</div>
