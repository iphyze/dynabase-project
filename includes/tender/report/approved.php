<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all approved tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Approved Tender</div>

    <a href="downloads/approved_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'approved' ORDER BY id DESC");
                ...
                ?>
                <tr>
                    <td colspan="7">No projects have been approved yet!</td>
                </tr>
                <?php
                }
                ?>
