<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all awarded tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Awarded Tender</div>

    <a href="downloads/awarded_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE progress = 'awarded' ORDER BY id DESC");
