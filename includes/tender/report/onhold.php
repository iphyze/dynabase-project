<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all tender on hold details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Tender On Hold</div>

    <a href="downloads/onhold_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'On Hold' ORDER BY id DESC");
                ...
                ?>
                <tr>
                    <td colspan="7">No tenders on hold!</td>
                </tr>
                <?php
                }
                ?>
