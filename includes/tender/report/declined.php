<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all declined tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Declined Tender</div>

    <a href="downloads/declined_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'declined' ORDER BY id DESC");
