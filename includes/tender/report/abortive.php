<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all aborted tender details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">Aborted Tender</div>

    <a href="downloads/abortive_report.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM project_info_table WHERE project_status = 'abortive' ORDER BY id DESC");
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            }elseif($project_status == "Abortive"){
                                echo '<span class="stat-abortive">Abortive</span>';
                            }
                ...
                ?>
                <tr>
                    <td colspan="7">No tender have been declined!</td>
                </tr>
                <?php
                }
                ?>
