<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        This allows for veiwing clients survey
        </div>
        ...
        <div class="date-display">Date: <?php echo date('jS M, Y'); ?></div>
            ...
            <div class="box-wrapper">
                ...
                <div class="bx-wrapper-col bxwc-split wow fadeInUp" data-wow-delay='.5s'>
                        ...
                        <a href="index.php?page=view_survey" class="grid-box-col gb-color-1">
                            <div class="grid-box-title">Total Client's Survey</div>
                            <div class="grid-box-figure"><?php getTotalClientsSurvey() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            <!--<div class="grid-box-days">Last Added: Document</div>-->            
                        </a>

                        <!-- <a href="index.php?page=add_woi" class="grid-box-col gb-color-2">
                            <div class="grid-box-title">Add New</div>
                            <div class="grid-box-figure fas fa-plus"><?php //getTotalKeypersons() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            <div class="grid-box-days">Last Added: Document</div>
                        </a>
