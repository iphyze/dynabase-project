...
$select = mysqli_query($db, "SELECT * FROM clients_table WHERE clients_name LIKE '%$search%' || clients_email LIKE '%$search%' || clients_hq_location LIKE '%$search%' || clients_category LIKE '%$search%'");
