<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        Clients Prequalification    
        </div>
        <div class="user-welcome-subtext wow fadeIn" data-wow-delay='.5s'>
        Create Client's Prequalification Checklist    
        </div>
        ...
        <div class="date-display">Date: <?php echo date('jS M, Y'); ?></div>
            ...
            <div class="box-wrapper">
                ...
                <div class="bx-wrapper-col bxwc-split wow fadeInUp" data-wow-delay='.5s'>
                        ...
                        <a href="index.php?page=prequalification" class="grid-box-col gb-color-1">
                            <div class="grid-box-title">Prequalifications</div>
                            <div class="grid-box-figure"><?php getTotalPreq() ?></div>
						...
						<!--
						<a href="index.php?page=clients" class="grid-box-col gb-color-3">
                            <div class="grid-box-title">Add New Clients</div>
							<!--<div class="grid-box-figure"><?php //getTotalPresentationDocuments() ?> 8</div>-->
                            <!--<div class="grid-box-days">Last Added: Document</div>-->
						<!--</a>-->
				
						<!--
                        <a href="index.php?page=keypersons" class="grid-box-col gb-color-4">
                            <div class="grid-box-title">Add New Keyperson</div>
