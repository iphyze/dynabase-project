<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        This allows for document upload & consistent update of documents    
        </div>
            ...
            <div class="box-wrapper">
                ...
                <div class="bx-wrapper-col bxwc-split wow fadeInUp" data-wow-delay='.5s'>
                        ...
                        <a class="grid-box-col gb-color-1">
                            <div class="grid-box-title">Total Documents</div>
                            <div class="grid-box-figure"><?php getTotalDocuments() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            <!--<div class="grid-box-days">Last Added: Document</div>-->            
                        </a>
                        <a href="index.php?page=profile_document" class="grid-box-col gb-color-2">
                            <div class="grid-box-title">Profile</div>
                            <div class="grid-box-figure"><?php getTotalProfileDocuments() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            <!--<div class="grid-box-days">Last Added: Document</div>-->
                        </a>
                        <a href="index.php?page=presentation_document" class="grid-box-col gb-color-3">
                            <div class="grid-box-title">Presentation</div>
                            <div class="grid-box-figure"><?php getTotalPresentationDocuments() ?></div>
                            <div class="circle-one"></div>
                            <div class="circle-two"></div>
                            <!--<div class="grid-box-days">Last Added: Document</div>-->
                        </a>
