<div class="home-heading">
    ...
    <div class="home-heading-col-1">
        ...
        View all profile document details below, edit, delete data. 
        </div>
...
<div class="table-container">
    ...
    <div class="form-title">All Profile Documents</div>
...
<!--<a href="all_report_tender.php" class='success-message theme-color'><i class='fas fa-file'></i> Export Excel</a>-->
        ...
        <table>
            ...
            <tbody>
                ...
                <?php
                    ...
                    $select = mysqli_query($db, "SELECT * FROM document_table WHERE document_type = 'Profile' ORDER BY id DESC LIMIT $offset, $results_per_page");
    ...
    <div class="pagination-box">
        <?php include_once('pagination/profile_pagination.php');?>
    </div>
